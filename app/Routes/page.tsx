  ...
  const routes = [
    {
      ...
      duration: "4-5 hours",
      stops: ["Jeddah", "Rabigh"],
      description: "The sacred journey between the two holy cities. Our comfortable vehicles make this trip smooth and convenient for pilgrims.",
      image: "/makkah-madinah.jpg",
      price: "$120-$250",
      popular: true,
      features: ["Direct routes available", "Rest stops available", "Comfortable seating", "Air conditioning", "Bottled water"]
    },
    {
      id: 2,
      ...
      stops: [],
      description: "Reliable airport transfers to get you to Makkah quickly after your flight. Available 24/7 to match flight schedules.",
      image: "/jeddah-makkah.jpg",
      price: "$50-$120",
      features: ["24/7 availability", "Flight tracking", "Luggage assistance", "Meet & greet service"]
    },
    {
      id: 3,
      name: "Madinah Airport to City Center",
      distance: "15 km",
      duration: "20-30 minutes",
      stops: [],
      description: "Quick transfers from Prince Mohammad Bin Abdulaziz Airport to your hotel in Madinah.",
      image: "/madinah-airport.jpg",
      price: "$30-$80",
      features: ["Quick transfers", "Multiple vehicle options", "English speaking drivers"]
    },
    {
      id: 4,
      name: "Makkah to Mina",
      ...
      stops: [],
      description: "Essential transportation for Hajj pilgrims during the days of Hajj. Our drivers know the best routes to avoid congestion.",
      image: "/minaroute.jpg",
      price: "$40-$100",
      popular: true,
      features: ["Hajj season specialists", "Multiple departures", "Large capacity vehicles", "Experienced with Hajj routes"]
    },
    {
      id: 5,
      name: "Mina to Arafat",
      ...
      stops: [],
      description: "Crucial transportation on the Day of Arafat. We ensure timely arrival for this important Hajj ritual.",
      image: "/arafatroute.jpg",
      price: "$50-$120",
      features: ["Early morning departures", "Priority routing", "Air conditioned comfort"]
    },
    {
      id: 6,
      name: "Arafat to Muzdalifah",
      distance: "9 km",
      duration: "1-1.5 hours",
      stops: [],
      description: "Night-time transportation after sunset on the Day of Arafat. Our drivers are experienced with this important Hajj movement.",
      image: "/muzdalifahroute.jpg",
      price: "$60-$140",
      features: ["Night driving specialists", "Comfortable for tired pilgrims", "Safe and reliable"]
    },
    {
      id: 7,
      name: "Makkah to Taif",
      ...
      duration: "2 hours",
      stops: ["Al Hada"],
      description: "Scenic route to the mountain city of Taif, perfect for a break from the heat of Makkah.",
      image: "/taifroute.jpg",
      price: "$80-$180",
      features: ["Mountain route experts", "Comfort stops available", "Beautiful scenery"]
    },
    {
      id: 8,
      name: "Makkah to Jeddah City",
      distance: "75 km",
      duration: "1-1.5 hours",
      stops: [],
      description: "Frequent service between Makkah and Jeddah for shopping, medical visits, or other needs.",
      image: "/jeddah-city.jpg",
      price: "$50-$130",
      popular: true,
      features: ["Flexible scheduling", "Multiple drop-off points", "Frequent departures"]
    }
  ]
