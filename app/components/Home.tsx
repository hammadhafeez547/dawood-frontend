  ...
  return (
    <main className="relative overflow-x-hidden">
      ...
      <div className="relative w-full h-screen overflow-hidden">
        {/* Image Background with Enhanced Parallax */}
        <div
        ...
        {/* Decorative Pattern Overlay with Subtle Movement */}
        <div
          className="absolute inset-0 bg-[url('/pattern.png')] opacity-15 z-3"
          style={{
        ...
        {/* Decorative Elements */}
        <div
          className="absolute top-[20%] left-[10%] w-24 h-24 border border-orange-300/20 rounded-full z-3 opacity-60"
          style={{
            transform: `translateY(${scrollY * -0.2}px)`,
          }}
        />
        <div
          className="absolute bottom-[30%] right-[15%] w-40 h-40 border border-orange-300/20 rounded-full z-3 opacity-40"
          style={{
        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center px-4">
          <div className="text-white text-center max-w-[1100px]">
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold mb-2 tracking-wide"
            >
              <span className="block font-serif">Dawood Tours & Travels</span>
              <span className="block text-xl sm:text-2xl md:text-3xl mt-2 font-light text-orange-200">
                Your Journey to Sacred Destinations
              </span>
            </motion.h1>
