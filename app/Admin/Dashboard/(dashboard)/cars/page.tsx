...
formData.append("popular", newCar.popular.toString());
      ...
      if (editCarId) {
        ...
        await axios.put(`https://dawood-backend.vercel.app//cars/${editCarId}`, formData, {
          headers: { "Content-Type": "multipart/form-data" },
        });
      } else {
        console.log(formData);
        await axios.post("https://dawood-backend.vercel.app//cars/car-add", formData, {
          headers: { "Content-Type": "multipart/form-data" },
        });
      }
  ...
  const handleDeleteCar = async (id : string) => {
    ...
    try {
      await axios.delete(`https://dawood-backend.vercel.app//cars/${id}`);
      fetchCars();
    } catch (error) {
      console.error(error);
