...
const [dialogOpen, setDialogOpen] = useState<boolean>(false);
  ...
  const fetchCars = async () => {
    try {
      const res = await axios.get("https://dawood-backend-oxho.vercel.app/cars/all-cars");
      setCars(res.data);
    } catch (error) {
      console.error(error);
...
formData.append("popular", newCar.popular.toString());
      ...
      if (editCarId) {
        ...
        await axios.put(`https://dawood-backend-oxho.vercel.app/cars/${editCarId}`, formData, {
          headers: { "Content-Type": "multipart/form-data" },
        });
      } else {
        console.log(formData);
        await axios.post("https://dawood-backend-oxho.vercel.app/cars/car-add", formData, {
          headers: { "Content-Type": "multipart/form-data" },
        });
      }
  ...
  const handleDeleteCar = async (id : string) => {
    ...
    try {
      await axios.delete(`https://dawood-backend-oxho.vercel.app/cars/${id}`);
      fetchCars();
    } catch (error) {
      console.error(error);
  ...
  const handleToggleStatus = async (id : string) => {
    try {
      ...
      await axios.put(`https://dawood-backend-oxho.vercel.app//cars/${id}`, {
