...
import { Car, Clock, MapPin, Calendar, Users, CheckCircle, ArrowRight, Phone, Mail, Star } from "lucide-react"
  ...
  const transportOptions = [
    {
      id: "economy",
      title: "Economy",
      description: "Comfortable transportation in shared vehicles with other pilgrims.",
      price: "$50",
      perPerson: true,
      features: [
    ...
    },
    {
      id: "standard",
      title: "Standard",
      description: "Semi-private transportation with fewer passengers for a more comfortable journey.",
      price: "$80",
      perPerson: true,
      features: [
    ...
    },
    {
      id: "premium",
      title: "Premium",
      description: "Private transportation for your group with premium vehicles and personalized service.",
      price: "$120",
      perPerson: true,
      features: [
    ...
    },
    {
      id: "vip",
      title: "VIP",
      description: "Exclusive luxury transportation with premium amenities and personalized service.",
      price: "$500",
      perPerson: false,
      features: [
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="relative py-20 bg-gradient-to-b from-gray-900 to-gray-800 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image src="/madina2.jpg" alt="Madina Background" fill sizes="100vw" className="object-cover opacity-30" />
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <Badge className="bg-orange-600 hover:bg-orange-700 mb-4">Transportation Service</Badge>

            <h1 className="text-4xl md:text-5xl font-bold mb-4">{cars?.routeInfo?.title || "Makkah to Madinah"} Transportation</h1>
            <div className="w-24 h-1 bg-orange-500 mx-auto my-6"></div>
            <p className="text-lg text-gray-300 mb-8">
              Comfortable and reliable transportation services between the holy cities of Makkah and Madinah for a
              ...
              <Tabs defaultValue="overview" value={selectedTab} onValueChange={setSelectedTab}>
                ...
                <TabsContent value="overview" className="mt-0">
                  ...
                  >
                    ...
                    <div className="p-6">
                      <h2 className="text-2xl font-bold text-gray-800 mb-4">About Our Makkah to Madinah Service</h2>

                      {/* Safely map over 'about' content */}
                      {cars?.routeInfo.about?.map((point: string, index: number) => (
                      ...
                      {/* Service Highlights */}
                      <div className="mt-8">
                        <h3 className="text-xl font-bold text-gray-800 mb-4">Service Highlights</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {[
                            {
                              icon: <Car className="h-5 w-5 text-orange-500" />,
                              title: "Modern Fleet",
                              description: "Well-maintained vehicles with air conditioning and comfortable seating",
                            },
                            {
                              icon: <Users className="h-5 w-5 text-orange-500" />,
                              title: "Experienced Drivers",
                              description: "Professional drivers with extensive knowledge of the route",
                            },
                            {
                              icon: <Clock className="h-5 w-5 text-orange-500" />,
                              title: "Flexible Scheduling",
                              description: "Multiple departure times to suit your itinerary",
                            },
                            {
                              icon: <CheckCircle className="h-5 w-5 text-orange-500" />,
                              title: "Safety First",
                              description: "Strict safety protocols and regular vehicle maintenance",
                            },
                          ].map((item, idx) => (
                            <div key={idx} className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                              <div className="p-2 bg-orange-100 rounded-full">{item.icon}</div>
                              <div>
                      ...
                      <div className="mt-8">
                        ...
                        <p className="text-gray-600 mb-4">{cars?.routeInfo.journey}</p>
                ...
                <TabsContent value="options" className="mt-0">
                  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
                    <h2 className="text-2xl font-bold text-gray-800 mb-6">Transportation Options</h2>
                    <p className="text-gray-600 mb-8">
                      We offer a range of transportation options to suit different preferences and budgets. Choose the
                      service that best meets your needs for a comfortable journey between Makkah and Madinah.
                    </p>
                      ...
                      {cars?.transportOptions.map((option, index) => (
                        <motion.div
                          ...
                          className={`bg-white rounded-lg shadow-md overflow-hidden border ${
                            option.recommended ? "border-orange-400" : "border-transparent"
                          }`}
                        >
                          {option.recommended && (
                            ...
                            <div className="p-6 md:col-span-2">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-sm text-gray-600">{option.vehicleType}</span>
                                </div>
                                <div className="flex items-center gap-2">
                                  <Users className="h-4 w-4 text-orange-500" />
                                  <span className="text-sm text-gray-600">{option.capacity}</span>
                                </div>
                                <div className="flex items-center gap-2">
                 ...
                 <TabsContent value="schedule" className="mt-0">
                  ...
                  >
                    <h2 className="text-2xl font-bold text-gray-800 mb-6">On-Demand Transportation Service</h2>
                    <p className="text-gray-600 mb-8">
                      Unlike traditional bus services with fixed schedules, our Makkah to Madinah transportation service
                      operates 24/7 with vehicles available on-demand. Book your journey at a time that suits your
                      itinerary.
                    </p>
                    ...
                    <div className="bg-orange-50 rounded-lg p-6 border border-orange-100 mb-8">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-xl font-bold text-gray-800">24/7 Service Availability</h3>
                      </div>
                      <p className="text-gray-600 mb-4">
                        Our fleet of vehicles is available around the clock to accommodate your travel needs. Whether
                        you need an early morning departure or late-night transportation, we've got you covered.
                      </p>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                        <div className="bg-white p-4 rounded-lg shadow-sm">
                          <h4 className="font-medium text-gray-800 mb-2">Standard Response Time</h4>
                          <p className="text-sm text-gray-600">Vehicle arrives within 30-60 minutes of booking</p>
                        </div>
                        <div className="bg-white p-4 rounded-lg shadow-sm">
                          <h4 className="font-medium text-gray-800 mb-2">Advanced Booking</h4>
                          <p className="text-sm text-gray-600">Schedule your ride up to 30 days in advance</p>
                        </div>
                        <div className="bg-white p-4 rounded-lg shadow-sm">
                          <h4 className="font-medium text-gray-800 mb-2">Express Service</h4>
                          <p className="text-sm text-gray-600">Premium & VIP services available within 15-30 minutes</p>
                        </div>
                      </div>
                    </div>

                    {/* How It Works */}
                    <h3 className="text-xl font-bold text-gray-800 mb-4">How Our Service Works</h3>
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                      {[
                        {
                          step: 1,
                          title: "Book Your Ride",
                          description: "Use our website, app, or call our 24/7 hotline to book your transportation",
                          icon: <Phone className="h-6 w-6 text-orange-600" />,
                        },
                        {
                          step: 2,
                          title: "Confirmation",
                          description: "Receive instant confirmation with driver details and estimated arrival time",
                          icon: <CheckCircle className="h-6 w-6 text-orange-600" />,
                        },
                        {
                          step: 3,
                          title: "Driver Arrival",
                          description: "Your driver will arrive at your location at the scheduled time",
                    ...
                    {/* Pickup Locations */}
                    <h3 className="text-xl font-bold text-gray-800 mb-4">Flexible Pickup Locations</h3>
                    <p className="text-gray-600 mb-6">
                      We offer pickup services from various locations in Makkah to ensure convenience for all our
                      customers.
                    </p>
                      ...
                      <table className="w-full border-collapse">
                        <thead>
                          <tr className="bg-gray-100">
                            <th className="border px-4 py-3 text-left text-gray-700">Pickup Area</th>
                            <th className="border px-4 py-3 text-left text-gray-700">Service Types Available</th>
                            <th className="border px-4 py-3 text-left text-gray-700">Typical Journey Time</th>
                          </tr>
                        </thead>
                        <tbody>
                          {[
                            ...
                            <tr key={index} className={index % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                              <td className="border px-4 py-3 text-gray-800 font-medium">{location.area}</td>
                              <td className="border px-4 py-3 text-gray-600">{location.services}</td>
                              <td className="border px-4 py-3 text-gray-600">{location.time}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
                    ...
                    <div className="mt-8 bg-orange-50 border border-orange-200 rounded-lg p-4">
                      ...
                      <ul className="space-y-2 text-gray-600">
                        <li className="flex items-start gap-2">
                          ...
                          <span>
                            For immediate bookings, please allow 30-60 minutes for vehicle preparation and arrival.
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <ArrowRight className="h-5 w-5 text-orange-500 mt-0.5 flex-shrink-0" />
                          <span>
                            During peak seasons (Hajj, Ramadan, holidays), we recommend booking at least 24 hours in
                            advance.
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <ArrowRight className="h-5 w-5 text-orange-500 mt-0.5 flex-shrink-0" />
                          <span>
                            VIP and Premium services include priority dispatch and dedicated customer service.
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <ArrowRight className="h-5 w-5 text-orange-500 mt-0.5 flex-shrink-0" />
                          <span>Journey times may vary based on traffic, weather conditions, and prayer times.</span>
                        </li>
                      </ul>
                    </div>

                    <div className="mt-8 text-center">
                      <Button className="bg-orange-600 hover:bg-orange-700">Book Your Transportation Now</Button>
                    </div>
                  </motion.div>
                </TabsContent>
                ...
                <TabsContent value="faq" className="mt-0">
                  ...
                  >
                    ...
                    <p className="text-gray-600 mb-8">
                      Find answers to common questions about our Makkah to Madinah transportation services.
                    </p>
                    ...
                    <div className="mt-8 bg-gray-50 p-6 rounded-lg">
                      <h3 className="text-lg font-medium text-gray-800 mb-4">Still have questions?</h3>
                      <p className="text-gray-600 mb-4">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <Card className="shadow-md">
                <CardHeader className="bg-orange-600 text-white rounded-t-lg">
                  <CardTitle className="text-xl">Book Your Transportation</CardTitle>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <select className="w-full p-2 border border-gray-300 rounded-md">
                        ...
                        <option value="madinah-makkah">Madinah to Makkah</option>
                      </select>
                    </div>
                    <div>
                ...
                <CardFooter className="flex flex-col">
                  <Button className="w-full bg-orange-600 hover:bg-orange-700 mb-3">Check Availability</Button>
                  <p className="text-xs text-gray-500 text-center">No payment required to check availability</p>
                </CardFooter>
              </Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={index} className={`pb-4 ${index < 2 ? "border-b border-gray-200" : ""}`}>
                        <div className="flex justify-between items-start mb-2">
                          <div>
              ...
              <Card className="shadow-md bg-gray-50">
                <CardHeader>
                  ...
                  <CardDescription>Our team is here to help with your transportation needs</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-gray-800">transport@dawoodtours.com</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="p-2 bg-orange-100 rounded-full">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-gray-800">123 Tour Street, Makkah</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Explore our other transportation and travel services to enhance your pilgrimage experience.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Convenient transfers between Jeddah Airport and your hotel in Makkah or Madinah.",
                image: "/placeholder.svg?height=300&width=500",
                link: "/services/transportation/airport-transfers",
              },
              {
                title: "Ziyarat Tours",
                description: "Guided tours of historical and religious sites in Makkah and Madinah.",
                image: "/placeholder.svg?height=300&width=500",
                link: "/services/transportation/ziyarat-tours",
              },
              {
                title: "Hotel Pickups",
                description: "Reliable pickup services from your hotel to any destination.",
                image: "/placeholder.svg?height=300&width=500",
          ...
          <div className="bg-gradient-to-r from-orange-600 to-orange-500 rounded-xl overflow-hidden shadow-xl">
            <div className="p-8 md:p-12 text-center text-white">
              ...
              <p className="text-white/90 mb-8 max-w-2xl mx-auto">
                Secure your journey between Makkah and Madinah today and enjoy a comfortable, hassle-free travel
                experience.
              </p>
